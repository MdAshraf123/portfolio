                ...
                <div  className="md:h-[85vh] w-full bg-white flex flex-col md:flex-row-reverse"> 
                    ...
                    <div className=" grow basis-1/2 flex flex-col justify-center items-center px-7 md:pl-30 ">                       
                        ...
                        <div className="w-full">
                            <a href="mailto:mdashraf6776@gmail.com"  rel="noopener noreferrer" className="inline-block border mt-10  self-start p-2 w-fit h-fit rounded-sm cursor-pointer bg-blue-600 text-white font-light hover:text-white">Contact</a>
                        </div>                 
                    </div>
